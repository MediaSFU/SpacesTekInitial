  ...
  const renderSidebarCard = (space: Space) => {
    ...
    return (
      <TouchableOpacity
        ...
        onPress={() => router.replace({ pathname: `/space/[spaceId]`, params: { spaceId: space.id } })}
  ...
  const renderSpaceCard = ({item}: {item: Space}) => {
    ...
    const handleJoin = async () => {
      ...
      try {
        ...
        router.replace({ pathname: `/space/[spaceId]`, params: { spaceId: item.id } });
      } catch (error) {
        console.error(error);
    ...
    <View style={styles.spacesListLayout}>
      ...
      <View
        ...
        <TouchableOpacity
          ...
          onPress={() => router.replace({ pathname: '/create-space' })}
